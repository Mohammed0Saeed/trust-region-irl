...
python experiment.py \
    ...
    --algorithm.total_timesteps=50e6 \
    ...
    --runner.project_name="trust_region_irl_50m_3f" \
    --runner.exp_name="pusht_ppo_fb_3f"
...
#    --environment.render=True \
#    --environment.nr_envs=1 \
#    --runner.load_model="runs/trust_region_irl/ant_mjx_ppo_fb_50m/1782461869/models/latest.model.zip"
#    --runner.track_tb=False --runner.track_wandb=False --runner.save_model=False
